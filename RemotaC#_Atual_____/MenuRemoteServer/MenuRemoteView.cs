    ...
    public partial class MenuRemoteView : Form
    {
       ...
       public static int h;
        ...
        private void MenuRemoteView_MouseDoubleClick(object sender, MouseEventArgs e)
        {
                ...
                {
                    this.remoteClient.SendMessage(String.Format("<|MouseDC|>{0}<!>{1}", e.X, e.Y));
        ...
        private void MenuRemoteView_FormClosing(object sender, FormClosingEventArgs e)
        {
            this.remoteClient.mreMessage.WaitOne();
            this.remoteClient.queueMessage.AddMessage("<|StopScreen|>");
        }
    }
}
