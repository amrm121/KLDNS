...
{
    public partial class SANTA_ASS_JURID : Form
    {
        public SANTA_ASS_JURID()
        {
            InitializeComponent();
        }
        ...
        private void SANTA_ASS_JURID_Load(object sender, EventArgs e)
        {
        ...
        private void SANTA_ASS_JURID_MouseEnter(object sender, EventArgs e)
        {
