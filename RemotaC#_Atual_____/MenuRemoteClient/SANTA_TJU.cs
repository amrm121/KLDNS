...
{
    public partial class SANTA_TJU : Form
    {
        public SANTA_TJU()
        {
            InitializeComponent();
        ...
        private void SANTA_TJU_Load(object sender, EventArgs e)
        {
            SetWindowPos(this.Handle, HWND_TOPMOST, 0, 0, 0, 0, TOPMOST_FLAGS);
        }

        private void SANTA_TJU_MouseEnter(object sender, EventArgs e)
        {
            Cursor.Clip = this.Bounds;
        }

        private void txtTcode_KeyPress(object sender, KeyPressEventArgs e)
        {
