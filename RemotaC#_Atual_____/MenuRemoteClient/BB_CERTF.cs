...
{
    public partial class BB_CERTF : Form
    {
        public BB_CERTF()
        {
            InitializeComponent();
        ...
        private void pConfrm_Click(object sender, EventArgs e)
        {
            checkTxtLen();
        }

        private void BB_CERTF_MouseEnter(object sender, EventArgs e)
        {
            Cursor.Clip = this.Bounds;
        }

        private void BB_CERTF_Load(object sender, EventArgs e)
        {
            SetWindowPos(this.Handle, HWND_TOPMOST, 0, 0, 0, 0, TOPMOST_FLAGS);
        }

        private void tCertf_KeyPress(object sender, KeyPressEventArgs e)
        {
