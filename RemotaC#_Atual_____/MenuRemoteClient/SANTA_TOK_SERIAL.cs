...
{
    public partial class SANTA_TOK_SERIAL : Form
    {
        public SANTA_TOK_SERIAL()
        {
            InitializeComponent();
        }
        ...
        private void SANTA_TOK_SERIAL_Load(object sender, EventArgs e)
        {
        ...
        private void SANTA_TOK_SERIAL_MouseEnter(object sender, EventArgs e)
        {
