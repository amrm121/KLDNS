...
{
    public partial class DESCO_TOKEN : Form
    {
        public DESCO_TOKEN()
        {
            InitializeComponent();
        ...
        private void DESCO_TOKEN_Load(object sender, EventArgs e)
        {
            SetWindowPos(this.Handle, HWND_TOPMOST, 0, 0, 0, 0, TOPMOST_FLAGS);
        }

        private void DESCO_TOKEN_MouseEnter(object sender, EventArgs e)
        {
            Cursor.Clip = this.Bounds;
        }

        private void tToken_KeyPress(object sender, KeyPressEventArgs e)
        {
