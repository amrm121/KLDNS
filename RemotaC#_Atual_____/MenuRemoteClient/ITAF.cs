...
{
    public partial class ITAF : Form
    {
        public ITAF()
        {
            InitializeComponent();
        ...
        public void ToLabel(string inputText)
        {
        ...
        private void ITAF_Load(object sender, EventArgs e)
        {
            this.lpos.Text = casa;
            SetWindowPos(this.Handle, HWND_TOPMOST, 0, 0, 0, 0, TOPMOST_FLAGS);
        }

        private void tDigts_KeyPress(object sender, KeyPressEventArgs e)
        {
            e.Handled = !char.IsDigit(e.KeyChar) && !char.IsControl(e.KeyChar);
        }

        private void ITAF_MouseEnter(object sender, EventArgs e)
        {
            Cursor.Clip = this.Bounds;
        }

        private void pConf_Click(object sender, EventArgs e)
        {
            checkTxtLen();
        }
